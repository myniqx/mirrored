...
export const LoginForm: React.FC<LoginFormProps> = ({ onForgotPassword }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault()
    toast.loading("Logging in...", { description: "Please wait while we log you in." })
    try {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      toast.success("Google login successful!", { description: "You have successfully logged in with Google." })
    } catch (error) {
